...
// myfix for minage
unsigned int nStakeMinAge = 5 * 60; // min age is 5 min 
//unsigned int nStakeMinAge = 12 * 60 * 60; // min age is 12 hours
...
const string strMessageMagic = "IZEcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
        ...
        {
            nSubsidy = 64000000 * COIN; //  64M COINs for initial coin supply
        } else {
            nSubsidy = 0;
        }
